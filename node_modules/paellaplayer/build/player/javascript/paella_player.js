...
paella.player = null;
paella.version = "6.5.5 - build: 41bc11a9";
      ...
      value: function createCloseButton() {
        ...
        if (this._messageContainer) {
          ...
          $(closeButton).click(function (event) {
            return _this2.onCloseButtonClick();
          });
    ...
    function VideoRect(id, domType, left, top, width, height) {
      ...
      if (zoomEnabled) {
        ...
        $(eventCapture).on('mousemove', function (evt) {
          ...
          if ((Math.abs(offset.x) > 80 || Math.abs(_this.y) > 80) && _this.drag) {
            _this._mouseDown = mouse;
            return;
          }

          _this.drag = evt.buttons > 0;

          if (_this.drag) {
            paella.player.videoContainer.disablePlayOnClick();
            panImage.apply(_assertThisInitialized(_this), [offset]);
            _this._mouseDown = mouse;
          }
        });
...
(function () {
  ...
  var VideoContainerBase = /*#__PURE__*/function (_paella$DomNode4) {
    ...
    function VideoContainerBase(id) {
      ...
      _this5._force = false;
      _this5._clickEventsEnabled = true;
    ...
    _createClass(VideoContainerBase, [{
      ...
      value: function enablePlayOnClick() {
        ...
        if (timeout) {
          this._clickEventsTimeout = setTimeout(function () {
            _this8._clickEventsEnabled = true;
          }, timeout);
        } else {
      ...
      value: function seekTo(newPositionPercent) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          paella.player.videoContainer.currentTime().then(function (t) {
            ...
            if (_this9._seekTimeLimit > 0 && _this9._seekType == paella.SeekType.BACKWARDS_ONLY) {
              time = _this9._seekTimeLimit;
            }
            ...
            _this9.setCurrentPercent(newPositionPercent).then(function (timeData) {
              _this9._force = true;
      ...
      value: function seekToTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          paella.player.videoContainer.currentTime().then(function (currentTime) {
            if (_this10._seekTimeLimit && _this10._seekType == paella.SeekType.BACKWARDS_ONLY) {
              currentTime = _this10._seekTimeLimit;
            }

            switch (_this10._seekType) {
              case paella.SeekType.FULL:
                break;
            ...
            _this10.setCurrentTime(time).then(function (timeData) {
              _this10._force = true;

              _this10.triggerTimeupdate();
      ...
      value: function trimStart() {
        ...
        return new Promise(function (resolve) {
          resolve(_this11._trimming.start);
        });
      }
    }, {
      key: "trimEnd",
      ...
      value: function trimEnabled() {
        ...
        return new Promise(function (resolve) {
          resolve(_this13._trimming.enabled);
        });
      }
    }, {
      key: "trimming",
      ...
      value: function setTrimming(start, end) {
        ...
        return new Promise(function (resolve) {
          ...
          _this15.currentTime(true).then(function (c) {
            currentTime = c;
            return _this15.duration();
          }).then(function (duration) {
            _this15._trimming.start = Math.floor(start);
            _this15._trimming.end = Math.floor(end);

            if (_this15._trimming.enabled) {
              if (currentTime < _this15._trimming.start) {
                _this15.setCurrentTime(0);
              }

              if (currentTime > _this15._trimming.end) {
                _this15.setCurrentTime(duration);
              }
            ...
            paella.events.trigger(paella.events.setTrim, {
              trimEnabled: _this15._trimming.enabled,
              trimStart: _this15._trimming.start,
              trimEnd: _this15._trimming.end
            });
            resolve();
          });
        });
      ...
      value: function setCurrentPercent(percent) {
        ...
        return new Promise(function (resolve) {
          _this16.duration().then(function (d) {
            ...
            return _this16.setCurrentTime(position);
      ...
      value: function ended() {
        ...
        return new Promise(function (resolve) {
          ...
          _this17.duration().then(function (d) {
            duration = d;
            return _this17.currentTime();
          }).then(function (currentTime) {
    ...
    _createClass(StreamProvider, [{
      ...
      value: function init(videoData) {
        ...
        this._videoData.forEach(function (stream, index) {
          ...
          if (stream.role == 'master') {
            _this18._mainStream = stream;
          }

          if (stream.type == 'video') {
            _this18._videoStreams.push(stream);
          } else if (stream.type == 'audio') {
            _this18._audioStreams.push(stream);
          }
        });
        ...
        this._videoStreams.forEach(function (videoStream, index) {
          ...
          player.setVideoQualityStrategy(_this18._qualityStrategy);
          player.setAutoplay(autoplay);

          if (videoStream == _this18._mainStream) {
            _this18._mainPlayer = player;
            _this18._audioPlayer = player;
          } else {
            player.setVolume(0);
          }

          _this18._videoPlayers.push(player);

          _this18._players.push(player);
        }); // Create audio player
        ...
        this._audioStreams.forEach(function (audioStream, index) {
          ...
          if (player) {
            _this18._audioPlayers.push(player);
      ...
      value: function startVideoSync(syncProviderPlayer) {
        ...
        var sync = function sync() {
          _this19._syncProviderPlayer.currentTime().then(function (t) {
            _this19.players.forEach(function (player) {
          ...
          _this19._syncTimer = setTimeout(function () {
            return sync();
          }, 1000);
        };
      ...
      value: function callPlayerFunction(fnName) {
        ...
        return new Promise(function (resolve, reject) {
          Promise.all(promises).then(function () {
            if (fnName == 'play' && !_this20._firstPlay) {
              _this20._firstPlay = true;

              if (_this20._startTime) {
                _this20.players.forEach(function (p) {
                  return p.setCurrentTime(_this20._startTime);
                });
              }
            }
  ...
  var VideoContainer = /*#__PURE__*/function (_paella$VideoContaine) {
    ...
    function VideoContainer(id) {
      ...
      _this21 = _super6.call(this, id);
      _this21._streamProvider = new paella.StreamProvider();
      _this21._ready = false;
      _this21._videoWrappers = [];
      _this21._container = new paella.DomNode('div', 'playerContainer_videoContainer_container', {
        position: 'relative',
        display: 'block',
        marginLeft: 'auto',
        marginRight: 'auto',
      ...
      _this21._container.domElement.setAttribute('role', 'main');

      _this21.addNode(_this21._container);

      _this21.overlayContainer = new paella.VideoOverlay(_this21.domElement);

      _this21.container.addNode(_this21.overlayContainer);

      _this21.setProfileFrameStrategy(paella.ProfileFrameStrategy.Factory());

      _this21.setVideoQualityStrategy(paella.VideoQualityStrategy.Factory());

      _this21._audioTag = paella.player.config.player.defaultAudioTag || paella.utils.dictionary.currentLanguage();
      _this21._audioPlayer = null; // Initial volume level

      _this21._volume = paella.utils.cookies.get("volume") ? Number(paella.utils.cookies.get("volume")) : 1;

      if (paella.player.startMuted) {
        _this21._volume = 0;
      }

      _this21._muted = false;
      return _this21;
    ...
    _createClass(VideoContainer, [{
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          _this22.ended().then(function (ended) {
            if (ended) {
              _this22._streamProvider.startTime = 0;

              _this22.seekToTime(0);
            } else {
              _this22.streamProvider.startTime = _this22._startTime;
            }

            return _this22.streamProvider.callPlayerFunction('play');
          }).then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "play", _this22).call(_this22);
      ...
      value: function pause() {
        ...
        return new Promise(function (resolve, reject) {
          _this23.streamProvider.callPlayerFunction('pause').then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "pause", _this23).call(_this23);
      ...
      value: function currentTime() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this25.masterVideo().currentTime();
          }).then(function (time) {
            if (trimmingData.enabled) {
      ...
      value: function mute() {
        ...
        return new Promise(function (resolve) {
          ...
          _this26._audioPlayer.setVolume(0).then(function () {
      ...
      value: function unmute() {
        ...
        return new Promise(function (resolve) {
          _this27._muted = false;

          _this27._audioPlayer.setVolume(_this27._volume).then(function () {
            paella.events.trigger(paella.events.setVolume, {
              master: _this27._volume
            });
            resolve();
          });
        });
      ...
      value: function setVolume(params) {
        ...
        if (_typeof(params) == 'object') {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this28._volume = params;

            _this28._audioPlayer.setVolume(params).then(function () {
              paella.events.trigger(paella.events.setVolume, {
                master: params
              });
              resolve(params);
      ...
      value: function duration() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this29.masterVideo().duration();
          }).then(function (duration) {
            if (trimmingData.enabled) {
      ...
      value: function getAudioTags() {
        ...
        return new Promise(function (resolve) {
          var lang = [];
          var p = _this30.streamProvider.players;
      ...
      value: function setAudioTag(lang) {
        ...
        return new Promise(function (resolve) {
          ...
          _this31.streamProvider.players.forEach(function (player) {
            if (!firstAudioPlayer) {
          ...
          if (!audioSet && _this31.streamProvider.mainVideoPlayer) {
            _this31._audioPlayer = _this31.streamProvider.mainVideoPlayer;
          } else if (!audioSet && firstAudioPlayer) {
            _this31._audioPlayer = firstAudioPlayer;
          }

          Promise.all(promises).then(function () {
            return _this31._audioPlayer.setVolume(_this31._volume);
          }).then(function () {
            _this31._audioTag = _this31._audioPlayer.stream.audioTag;
            paella.events.trigger(paella.events.audioTagChanged);

            _this31.streamProvider.startVideoSync(_this31.audioPlayer);
      ...
      value: function setStreamData(videoData) {
        ...
        return new Promise(function (resolve, reject) {
          _this32.streamProvider.init(videoData);
          ...
          videoData.forEach(function (video) {
            ...
            if (video.audioTag == _this32._audioTag) {
              streamDataAudioTag = _this32._audioTag;
            }
          });

          if (streamDataAudioTag != _this32._audioTag && streamDataAudioTag != null) {
            _this32._audioTag = streamDataAudioTag;
          }

          _this32.streamProvider.videoPlayers.forEach(function (player, index) {
            addVideoWrapper.apply(_this32, ['videoPlayerWrapper_' + index, player]);
            player.setAutoplay(_this32.autoplay());
          });

          _this32.streamProvider.loadVideos().catch(function (err) {
            reject(err);
          }).then(function () {
            return _this32.setAudioTag(_this32.audioTag);
          }).then(function () {
            var endedTimer = null;

            var setupEndEventTimer = function setupEndEventTimer() {
              _this32.stopTimeupdate();
            ...
            var eventBindingObject = _this32.masterVideo().video || _this32.masterVideo().audio;

            $(eventBindingObject).bind('timeupdate', function (evt) {
              _this32.trimming().then(function (trimmingData) {
                ...
                if (current >= duration) {
                  _this32.streamProvider.callPlayerFunction('pause');
      ...
      value: function getVideoData() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          _this33.currentTime().then(function (currentTime) {
            videoData.currentTime = currentTime;
            return _this33.volume();
          }).then(function (v) {
            videoData.volume = v;
            return _this33.duration();
          }).then(function (d) {
            videoData.duration = d;
            return _this33.paused();
          }).then(function (p) {
            videoData.paused = p;
            return _this33.trimming();
          }).then(function (trimming) {
...
(function () {
  ...
  var SearchCallback = /*#__PURE__*/function (_paella$utils$AsyncLo) {
    _inherits(SearchCallback, _paella$utils$AsyncLo);
    ...
    _createClass(PlaybackBarCanvas, [{
      ...
      get: function get() {
        ...
        if (!this._canvas) {
          var createCanvas = function createCanvas(index) {
            ...
            result.width = $(_this3.parent).width();
            result.height = $(_this3.parent).height();
            return result;
          };
      ...
      value: function drawCanvas() {
        ...
        paella.player.videoContainer.duration(true).then(function (d) {
          ...
          var ctx = _this4.context;
          var w = _this4.width;
          var h = _this4.height;

          _this4.clearCanvas();

          _this4._plugins.forEach(function (plugin) {
...
(function () {
  var LoaderContainer = /*#__PURE__*/function (_paella$DomNode) {
    ...
    function LoaderContainer(id) {
      ...
      _this.timer = new paella.utils.Timer(function (timer) {
  ...
  var InitDelegate = /*#__PURE__*/function () {
    ...
    _createClass(InitDelegate, [{
      ...
      value: function loadDictionary() {
        ...
        return new Promise(function (resolve) {
          paella.utils.ajax.get({
            url: _this.initParams.dictionaryUrl + "_" + paella.utils.dictionary.currentLanguage() + '.json'
...
paella.addPlugin(function () {
  var PlayButtonOnScreenAlwaysPlugin = /*#__PURE__*/function (_paella$EventDrivenPl) {
    ...
    var _super = _createSuper(PlayButtonOnScreenAlwaysPlugin);
    ...
    function PlayButtonOnScreenAlwaysPlugin() {
      ...
      _this = _super.call(this);
      _this.containerId = 'paella_plugin_PlayButtonOnScreen_Always';
    ...
    _createClass(PlayButtonOnScreenAlwaysPlugin, [{
      ...
      value: function setup() {
        ...
        $(this.container).click(function () {
          return _this2.onPlayButtonClick();
        });
      }
    }, {
      key: "checkEnabled",
      value: function checkEnabled(onSuccess) {
        ...
        paella.data.read('relatedVideos', {
          ...
          _this3.showOnEnd = !Array.isArray(data) || data.length == 0;
        });
        onSuccess(true);
      }
    }, {
  ...
  var FlexSkipPlugin = /*#__PURE__*/function (_paella$ButtonPlugin) {
    ...
    _createClass(FlexSkipPlugin, [{
      ...
      value: function action(button) {
        ...
        paella.player.videoContainer.currentTime().then(function (currentTime) {
          paella.player.videoContainer.seekToTime(currentTime - _this.config.seconds);
        });
      }
    }]);
  ...
  return /*#__PURE__*/function (_paella$plugins$FlexS) {
    ...
    _createClass(FlexSkipForwardPlugin, [{
      ...
      value: function action(button) {
        ...
        paella.player.videoContainer.currentTime().then(function (currentTime) {
          paella.player.videoContainer.seekToTime(currentTime + _this2.config.seconds);
        });
      }
    }]);
      ...
      value: function setupHls(video, url) {
        ...
        return new Promise(function (resolve, reject) {
          _this2._loadDeps().then(function (Hls) {
            if (Hls.isSupported()) {
              var _this2$stream, _this2$stream$sources, _this2$stream$sources2;

              var cfg = _this2.config; //cfg.autoStartLoad = false;

              _this2._hls = new Hls(cfg);
              var hlsStream = ((_this2$stream = _this2.stream) === null || _this2$stream === void 0 ? void 0 : (_this2$stream$sources = _this2$stream.sources) === null || _this2$stream$sources === void 0 ? void 0 : (_this2$stream$sources2 = _this2$stream$sources.hls) === null || _this2$stream$sources2 === void 0 ? void 0 : _this2$stream$sources2.length) > 0 && _this2.stream.sources.hls[0];
    ...
    _createClass(DefaultKeyPlugin, [{
      ...
      value: function toggleFullScreen() {
        ...
        if (paella.player.isFullScreen()) {
          ...
          paella.player.pause();
          paella.player.videoContainer.currentTime().then(function (currentTime) {
            var obj = _this.secondsToHours(currentTime);
    ...
    _createClass(PlayPauseButtonPlugin, [{
      ...
      value: function setup() {
        ...
        paella.events.bind(paella.events.play, function (event) {
          ...
          _this2.setToolTip(paella.utils.dictionary.translate("Pause (k)"));
        });
        paella.events.bind(paella.events.pause, function (event) {
          ...
          _this2.setToolTip(paella.utils.dictionary.translate("Play (k)"));
        });
      ...
      value: function endVideo() {
        ...
        paella.player.videoContainer.ended().then(function (ended) {
          if (ended) {
            ...
            _this4.showIcon = _this4.showOnEnd;
